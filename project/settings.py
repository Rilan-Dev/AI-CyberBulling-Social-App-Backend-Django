...
# Disable APPEND_SLASH to prevent trailing slash issues with POST requests
APPEND_SLASH = False
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        ...
        'rest_framework.permissions.IsAuthenticated',  # Change back from AllowAny
    ],
...
SWAGGER_SETTINGS = {
    ...
    'PERSIST_AUTH': True,       # Keep auth between refreshes
}
